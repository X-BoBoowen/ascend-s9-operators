...
index_add_fast_lib="/home/ma-user/work/s9/index_add_fast_project_v1/build_out/op_api/lib"
export LD_LIBRARY_PATH="${index_add_fast_lib}:${ASCEND_OPP_PATH:?}/vendors/customize/op_api/lib/:${LD_LIBRARY_PATH:-}"
...
python3 ../collect_artifact.py "IndexAdd" "$case_id" \
