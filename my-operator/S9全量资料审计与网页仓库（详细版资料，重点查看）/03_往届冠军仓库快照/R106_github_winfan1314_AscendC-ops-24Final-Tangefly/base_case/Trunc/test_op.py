...
case_data = {
    'case1': {
        'x1':np.random.uniform(-100, 100, [1024 * 1024]).astype(np.float16)
    },
    'case2': {
        'x1':(torch.rand([123511],dtype=torch.bfloat16) * 10) - 10 / 2
    },
    'case3': {
        'x1':np.random.uniform(-100, 100, [123511]).astype(np.int32)
    },
    'case4': {
        'x1':np.random.uniform(-100, 100, [123511]).astype(np.float32)
    },
