...
extern "C" __global__ __aicore__ void mat_mul(GM_ADDR x, GM_ADDR y, GM_ADDR bias, GM_ADDR z, GM_ADDR workspace, GM_ADDR tiling) {
    ...
    if (TILING_KEY_IS(1)) {
        ...
        TPipe pipeStage1;
        opStage1.InitStage1(x, y, workspace, tiling_data.bigCoreNumA, tiling_data.bigCoreStrideA, tiling_data.bigCoreNumB, tiling_data.bigCoreStrideB, tiling_data.maxCalcNumStage1, tiling_data.mLength, tiling_data.nLength, tiling_data.kLength);
        ...
        // SyncAll<false>();
        printf("hi372");
        opStage3.Init(workspace, bias, z, tiling_data.mLength, tiling_data.nLength, tiling_data.kLength, tiling_data.bigCoreNumM, tiling_data.bigCoreStrideM, tiling_data.hasBias, tiling_data.biasNLength, tiling_data.biasMLength, &pipeStage3);
        printf("hi374\n");
