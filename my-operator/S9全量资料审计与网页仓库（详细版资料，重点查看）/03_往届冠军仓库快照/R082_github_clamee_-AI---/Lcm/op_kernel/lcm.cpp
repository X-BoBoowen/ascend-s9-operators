...
public:
	...
	__aicore__ inline void Init(int N0, int N1, int N2, TPipe *pipe, GM_ADDR x1, GM_ADDR x2, GM_ADDR y)
	{
		...
		x1Gm.SetGlobalBuffer((__gm__ T *)x1, sizeX1);
	...
	__aicore__ inline void LcmLikely16(const LocalTensor<int16_t>& c, const LocalTensor<int16_t>& a, const LocalTensor<int16_t>& b) {
