...
class TestCustomOP(TestCase):
    def test_custom_op_case1(self):
        ...
        # 修改输入
        output = run_with_timeout(custom_ops_lib.custom_op, args=(condition_npu, then_npu, validate_indices,batch_dim,is_preprocessed,negative_index_support), timeout=30)
        if output is None:
