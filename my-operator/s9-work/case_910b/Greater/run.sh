...
greater_fast_lib="/home/ma-user/work/s9/greater_fast_project_v1/build_out/op_api/lib"
export LD_LIBRARY_PATH="${greater_fast_lib}:${ASCEND_OPP_PATH:?}/vendors/customize/op_api/lib/:${LD_LIBRARY_PATH:-}"
