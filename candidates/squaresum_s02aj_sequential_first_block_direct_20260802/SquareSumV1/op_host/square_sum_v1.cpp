    ...
    if (reduceMode != 0U) {
        ...
        desiredBlocks =
            adaptiveVectorTasks < MAX_BLOCK_DIM
                ? adaptiveVectorTasks
                : MAX_BLOCK_DIM;
    } else if (groupedLongVectorWidth != 0U) {
        const uint64_t vectorTasks =
            outputElements / groupedLongVectorWidth;
        desiredBlocks =
            vectorTasks < MAX_BLOCK_DIM
                ? vectorTasks
                : MAX_BLOCK_DIM;
    } else if (groupedMediumVectorWidth != 0U) {
        const uint64_t vectorTasks =
            outputElements / groupedMediumVectorWidth;
        desiredBlocks =
            vectorTasks < MAX_BLOCK_DIM
                ? vectorTasks
                : MAX_BLOCK_DIM;
                ...
                : (lastVector2
                    ...
                    : (lastVector1
                        ...
                        : (groupedVector8
                            ...
                            : (groupedVectorAdaptive
                                ? 6U
                                : (groupedLongVectorWidth == 4U
                                    ? 9U
                                    : (groupedLongVectorWidth == 2U
                                        ? 10U
                                        : (groupedLongVectorWidth == 1U
                                            ? 11U
                                            : (groupedMediumVectorWidth == 4U
                                                ? 9U
                                                : (groupedMediumVectorWidth == 2U
                                                    ? 10U
                                                    : (groupedMediumVectorWidth == 1U
                                                        ? 11U
                                                        : (useTreeFinalize
                                                            ? (useLongChunk ? 4U : 3U)
                                                            : (useLongChunk ? 2U : 1U))))))))))))));
