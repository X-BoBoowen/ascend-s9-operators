...
static ge::graphStatus TilingFunc(gert::TilingContext* context)
{
    ...
    constexpr uint64_t MIDDLE_FULL_ROWS_MIN_REDUCE = 512U;
    constexpr uint64_t MIDDLE_FULL_ROWS_MIN_INNER = 9U;
    constexpr uint64_t MIDDLE_FULL_ROWS_MAX_INNER = 129U;
    ...
    const bool middleFullRows =
        ...
        reduceElements >= MIDDLE_FULL_ROWS_MIN_REDUCE &&
        innerElements >= MIDDLE_FULL_ROWS_MIN_INNER &&
