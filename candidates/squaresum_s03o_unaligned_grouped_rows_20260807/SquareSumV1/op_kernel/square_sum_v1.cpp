...
template <
    ...
    bool STRIDED_GROUPED_PADDED_ROWS = false>
...
public:
    ...
    {
        if constexpr (STRIDED_GROUPED_PADDED_ROWS) {
...
private:
    ...
    {
        ProcessStridedGroupedRowsImpl<false>();
    }

    __aicore__ inline void ProcessStridedGroupedPaddedRows()
    {
        ProcessStridedGroupedRowsImpl<true>();
    }

    template <bool PADDED_ROWS>
    __aicore__ inline void ProcessStridedGroupedRowsImpl()
    {
