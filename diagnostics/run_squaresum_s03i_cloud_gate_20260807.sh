...
candidate_source="${repo_root}/candidates/squaresum_s03i_s02f_fast2_small_inner_tree_20260807/SquareSumV1"
artifact_dir="${repo_root}/artifact"
detail_root="${artifact_dir}/SquareSumV1/s03i_fast2_small_inner_tree"
...
echo "S03I_GATE_START work=${work_root}"
python3 diagnostics/squaresum_s03i_fast2_small_inner_tree_static_20260807.py
...
run_with_opp "${candidate_env}" python3 -c \
    'import torch, torch_npu, square_sum_v1_validation_lib; print("S03I_IMPORT_OK")'
...
value = {
    ...
    "baseline": "S02F",
    "candidate": "S03I",
    "hypothesis": "selectively port S02AY middle-tree tail handling and use 16K only for fastPath2 reduce>=2048 and inner<=64",
...
echo "S03I_GATE_PASS result=${artifact_dir}/result.json"
