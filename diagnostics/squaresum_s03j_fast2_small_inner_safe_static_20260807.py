...
CANDIDATE = (
    ROOT
    / "candidates"
    / "squaresum_s03j_s02f_fast2_small_inner_safe_20260807"
    / "SquareSumV1"
)
...
def main():
    ...
    assert "? (longContiguous ? 4U : 3U)" in host
    ...
    print("FP32_LONG_NON_TREE_BUFFER_BYTES=4096")
    print("SUMMARY: S03J selective middle-tree static audit passed")
