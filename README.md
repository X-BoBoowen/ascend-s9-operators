...
S02CD 尚无官方五 Case 结果；公开图谱不能替代正式平台证据，目标仍为
`prof_sum <= 1195.599 us` 且五项全部 Pass。
...
当前能够确认的是：截至 S02CA 的官方候选均为 `5/5 Pass`，但都没有
形成相对 S02BA `3985.330 μs` 的有效稳定提升；新候选 S02CD 已通过
