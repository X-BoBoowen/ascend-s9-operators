...
`3260.665 μs`、S03J 为 `3259.544 μs`，均已淘汰。此前 Event 图谱
不等价于官方评分口径，局部巨大收益也不能替代正式五 Case。S03K 是
当前唯一推荐提交的新候选：它通过 1130/1130 正确性，并在修改目标域
取得 84.7826% 聚合改善；源码、已验证 `.run` 与 ZIP 已固定，但尚无
正式平台成绩。
...
S03K 并逐 Case 对照 S02F/S03J；若目标路径没有映射到正式耗时，应回滚
