...
- 本地核验到 **28 个**按日期/版本保存的 SquareSumV1 ZIP：22 个有完整
  正式成绩，6 个没有完整平台成绩。S03K 的正式成绩为 `3277.140 μs`，
  比 S03J 慢 `17.596 μs（0.5398%）`、比历史最好 S02F 慢
  `53.145 μs（1.6484%）`，已淘汰。S03L 已完成真机门禁并打包，尚待
  正式平台成绩。
...
| 20 | S03E | 08-07 | 6.540 | 394.3775 | 238.865 | 1718.6145 | 902.268 | 3260.665 | -750.199 | +36.670 | `dd4b22bc7eb5` |
| 21 | S03J | 08-07 | 6.460 | 401.258 | 240.324 | 1717.544 | 893.958 | 3259.544 | -1.121 | +35.549 | `e775b0889148` |
| 22 | S03K | 08-07 | 7.692 | 402.132 | 242.372 | 1721.900 | 903.044 | 3277.140 | +17.596 | +53.145 | `9850faf54274` |
...
| S03L | `提交相关材料/20260807/S03L/SquareSumV1.zip` | `3a61968292fde3b3cc876b4dcac0e585a9bc039683ccd0767ff17522dd158d4f` | 1235/1235 正确；目标 A/B/A 聚合提升 89.6064%；等待正式平台成绩 |
...
| S03E | S03B + S03D，触发域互斥的组合候选 | 真机门禁通过，但平台正式为 3260.665，比 S02F 慢 36.670；已否决 |
| S03F | 在 S03E 上扩展 fastPath3 短尾 Split-K | 云端目标矩阵聚合回退 217.6840%，最坏单点回退 1134.8041%，否决且未打包 |
| S03G | 在 S03E 上扩展 fastPath1 输出 9～16 Split-K | 云端目标矩阵聚合回退 0.4920%，最坏单点回退 7.8792%，否决且未打包 |
| S03H | S02F 上仅切换 fastPath2 小-inner 16K chunk | FP16/BF16 无稳定收益；FP32 120/128，正确性失败，未打包 |
| S03I | S03H 加入幂次树归约 | 目标路径改善约 24%～41%，但 FP32 120/128，定位为 finalizer 缓冲区不足，未打包 |
| S03J | S03I 修复 FP32 缓冲区并保留 S02F tree key | 全量与边界 1061/1061；目标六点聚合改善 34.1427%；正式 3259.544，比 S02F 慢 35.549，否决 |
| S03K | fastPath2 大规模小-inner 完整输出行归属 | 1130/1130；正式 3277.140，比 S03J 慢 17.596、比 S02F 慢 53.145；五个 Case 全部回退，否决 |
| S03L | fastPath4 大规模多轴归约相邻保留行合并搬运 | 1235/1235；目标 15 点 A/B/A 聚合提升 89.6064%，最小单点提升 79.2200%；已打包待正式成绩 |
...
平台结果证明这些公开覆盖域没有命中决定隐藏 Case 总耗时的主路径；其中
Case5 相对 S02F 回退 `33.7105 μs`。因此局部门禁通过不能作为基线晋升
条件。后续 S03J 已从 S02F 独立重建且正式成绩为 3259.544，仍未命中
决定性隐藏路径；S03K 正式 3277.140 且五项全部回退，也已否决。S03L
转向通用 rank-5 fastPath4 相邻保留行合并搬运，详见
...
| S03E | `提交相关材料/20260807/S03E/SquareSumV1.zip` | `dd4b22bc7eb5000c07357bd9d2355bb6b8e7bdf9e61cb7e8fb4fb3a5196f19b2` |
| S03J | `提交相关材料/20260807/S03J/SquareSumV1.zip` | `e775b0889148ae5fe4c1d6dd678db90515bbe5c3eba3da894625d96308d17818` |
| S03K | `提交相关材料/20260807/S03K/SquareSumV1.zip` | `9850faf54274057338b76a6ea3a125c5d03fddc2dffd2c9e2769f6e864ed0365` |

### 7.1 已打包、尚无正式平台成绩

| 版本 | 文件位置 | SHA-256 | 状态 |
| --- | --- | --- | --- |
| S03L | `提交相关材料/20260807/S03L/SquareSumV1.zip` | `3a61968292fde3b3cc876b4dcac0e585a9bc039683ccd0767ff17522dd158d4f` | 1235/1235 正确；目标路径 A/B/A 聚合改善 89.6064%；等待正式平台成绩 |
